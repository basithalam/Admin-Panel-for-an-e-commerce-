...
namespace Ecommerce.Infrastructure.Data
{
    public class AppDbContext : DbContext
    {
        ...
        // DbSets expose tables in the database
        public DbSet<Category> Categories { get; set; } = null!; // Category table
        public DbSet<Product> Products { get; set; } = null!;   // Product table
        public DbSet<Order> Orders { get; set; } = null!;       // Order table
        public DbSet<OrderItem> OrderItems { get; set; } = null!; // OrderItem table
        public DbSet<Payment> Payments { get; set; } = null!;     // Payment table
